...
public class SetZdcs {
    ...
    public void setZdcs(Context context){
        ...
        edit.putString("0006","0");//SMS消息应答超时时间，单位为秒(s)
        edit.putString("0007","0");//SMS消息重传次数
        ...
        edit.putString("0027","20");//休眠时汇报时间间隔，单位为秒(s),>0
        edit.putString("0028","20");//紧急报警时汇报时间间隔，单位为秒(s),>0
        edit.putString("0029","20");//缺省时间汇报间隔，单位为秒(s),>0

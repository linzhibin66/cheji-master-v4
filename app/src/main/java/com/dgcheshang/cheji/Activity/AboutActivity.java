...
public class AboutActivity extends BaseInitActivity implements View.OnClickListener{
    ...
    private void initView() {
        ...
        View layout_update = findViewById(R.id.layout_update);//车尚科技
        ...
        dialog.setPositiveButton("确定",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        bundle.putSerializable("version",versionbean.getVersion());
                        msg.setData(bundle);
